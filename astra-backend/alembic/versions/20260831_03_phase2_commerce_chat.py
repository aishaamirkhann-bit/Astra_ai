...
def upgrade() -> None:
    op.add_column("cart_items", sa.Column("storage", sa.Text(), nullable=False, server_default=""))
    op.add_column("orders", sa.Column("storage", sa.Text(), nullable=False, server_default=""))
