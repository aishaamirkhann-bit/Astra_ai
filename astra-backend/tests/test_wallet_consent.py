def test_high_value_checkout_requires_consent_and_refunds_atomically(auth_client) -> None:
...
def test_otp_consent_is_amount_bound(auth_client) -> None:
    challenge = auth_client.post("/api/v1/wallet/authorize-consent", json={"amount": 51000, "auth_method": "OTP"})
